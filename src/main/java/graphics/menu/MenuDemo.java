...
import graphics.layoutD.CardLayoutDemo;
...
//воспользоваться лямбда-выражением для обработки выбора варианта выхода из программы
    ...
    public void paint(Graphics g) {
        ...
        if (debug.getState()) g.drawString("Debug is оп.", 10, 240);
        else g.drawString("Debug is off.", 10, 240);
        if (test.getState()) g.drawString("Testiпg is оп.", 10, 260);
        else g.drawString("Testiпg is off.", 10, 260);
    }
    ...
    class MyMenuHandler implements ActionListener, ItemListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            else if (arg.equals("Copy")) msg += "Сору.";
